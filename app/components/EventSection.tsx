...
const events = [
  {
    ...
    location: 'Jl. Mercedes Benz No.30, Cicadas, Kec. Gn. Putri, Kabupaten Bogor, Jawa Barat 16964',
  },
  {
    title: 'Resepsi',
        ...
        >
          ...
          <div className="flex flex-col md:flex-row gap-4 mt-6">
            ...
            <div className="bg-white p-3 rounded-xl flex items-center gap-3 shadow-sm w-full md:w-1/2">
              ...
              <span className="text-[#4A1C2D] font-medium text-base">{event.location}</span>
            </div>
